...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "My car had an MOT today, It didn't pass it's MOT unfortunately (my car is old and on its last legs). The staff were great, and explained the reason for it failing. I would recommend this garage, they were professional, reliable and good communicators. I would trust this garage and will happily use them again.",
    name: "Penny Jane Cook",
  },
